...
func TestResolveReasoningEffort(t *testing.T) {
	...
	tests := []struct {
		...
		{"output_config xhigh forwarded verbatim", "gpt-5.5", nil, effort("xhigh"), "xhigh"},
		{"old gpt max maps to high", "gpt-5.5", nil, effort("max"), "high"},
		...
		{"non gpt model forwards max verbatim", "claude-opus-5", nil, effort("max"), "max"},
